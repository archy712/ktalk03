...
class S {
  ...
  String get groupScreenText1 {
    return Intl.message('People', name: 'groupScreenText1', desc: '', args: []);
  }

  /// `Me`
  String get receiver {
    return Intl.message('Me', name: 'receiver', desc: '', args: []);
  }
